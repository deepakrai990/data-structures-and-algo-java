...
#### Output Format
<div style="background-color: #f9f9f9; padding: 5px 10px;">
    <p>Return a string array B where B[i] denotes the shortest unique 
    prefix to represent the i<sup>th</sup> word.</p>
</div>

```text
Return a string array B where B[i] denotes the shortest unique prefix to represent 
the i^th word.
```
#### Example Input
```text
