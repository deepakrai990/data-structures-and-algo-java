...
What is a COLORFUL Number:
    ...
    This number is a COLORFUL number, since the product of every 
    consecutive sequence of digits is different
```
#### Problem Constraints
...
Explanation 1:
     ...
     This number is a COLORFUL number since product of every 
     digit of a sub-sequence are different. 
...
Iterate over all the consecutive sequence of digits of the number 
and store the product in a set using hashing.
...
```
<pre>
<p>Time Complexity : O((log<sub>10</sub>A)<sup>2</sup>)</p>
<p>Space Complexity : O((log<sub>10</sub>A)<sup>2</sup>)</p>
</pre>
