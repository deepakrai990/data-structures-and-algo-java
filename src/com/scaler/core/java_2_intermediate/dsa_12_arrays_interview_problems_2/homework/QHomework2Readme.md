...
#### Problem Description
```text
You have 20 blue balls and 14 red balls in a bag. You put your 
hand in and remove 2 at a time.
...
Note: When you take the two balls out, you don’t put them back in, 
...
So In the case of (a) or (c), we are only removing one blue ball, but 
we always take off red balls two by two.

If there are 14 (even) red balls, we can not have one red ball left in 
the bag so that the last ball will be blue.
```
